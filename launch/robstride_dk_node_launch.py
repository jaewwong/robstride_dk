...
def generate_launch_description():
    ...
    args = [
        DeclareLaunchArgument("name", default_value="robstride_dk_node", description="node name"),
        DeclareLaunchArgument("namespace", default_value="", description="node namespace"),
        DeclareLaunchArgument("params", default_value=os.path.join(get_package_share_directory("robstride_dk"), "config", "params.yml"), description="path to parameter file"),
    ...
    nodes = [
        Node(
            package="robstride_dk",
            executable="robstride_dk_node",
